...
function HomeContent() {
  ...
  return (
    <div
      className={`min-h-screen px-4 py-2 sm:px-8 sm:py-4 flex flex-col justify-center items-center font-mono select-none relative transition-colors duration-300 ${
        isDarkMode ? "bg-[#18181b] text-white" : "bg-[#eeeeee] text-black"
      }`}
    >
      ...
      <div className={`z-10 w-full max-w-[1111px] flex-1 flex flex-col ${!username ? "justify-center" : ""} py-2 sm:py-4`}>
        ...
        <header className="flex justify-between items-center mb-4 sm:mb-6 gap-4">
          <h1
            ...
            className={`text-4xl sm:text-5xl md:text-6xl font-black tracking-wider uppercase font-mono cursor-pointer select-none transition-all duration-150 ${
        ...
        {newEmailAlert && (
          <div
            className={`border-4 p-4 mb-6 text-center font-black flex items-center justify-center gap-2 animate-bounce text-lg ${
              isDarkMode
          ...
          >
            ...
            <span>NEW EMAIL RECEIVED IN REALTIME!</span>
          </div>
        )}
        ...
        {!username ? (
          <>
            ...
            <div
              className={`border-4 p-4 sm:p-6 mb-8 transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 ${
                isDarkMode
            ...
            >
              <form onSubmit={handleSetUsername} className="flex flex-col sm:flex-row gap-4">
                <div
                  className={`relative flex-1 border-4 font-mono text-xl sm:text-2xl font-bold transition-all duration-150 ${
                    isDarkMode
                ...
                >
                  <input
                    ...
                    className={`w-full bg-transparent p-3 sm:p-4 outline-none font-bold sm:pr-[310px] ${
                      isDarkMode
                  ...
                  />
                  <span
                    className={`hidden sm:inline absolute right-4 top-1/2 -translate-y-1/2 font-mono text-sm sm:text-base font-bold pointer-events-none ${
                ...
                <button
                  type="submit"
                  className={`font-black px-8 py-3 text-2xl border-4 cursor-pointer transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-0.5 active:translate-y-0.5 flex items-center justify-center gap-2 uppercase ${
                    isDarkMode
                      ? "bg-[#ff5a5f] text-black border-white shadow-[4px_4px_0px_#ffffff] hover:bg-white hover:text-[#ff5a5f] hover:shadow-[7px_7px_0px_#ffffff] active:shadow-[1px_1px_0px_#ffffff]"
                      : "bg-[#ff5a5f] text-white border-black shadow-[4px_4px_0px_#000000] hover:bg-black hover:text-[#ff5a5f] hover:shadow-[7px_7px_0px_#000000] active:shadow-[1px_1px_0px_#000000]"
                  }`}
            ...
            {/* RULES CONTAINER */}
            <div
              className={`border-4 p-4 sm:p-6 mb-8 text-center transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 ${
                isDarkMode
                  ? "bg-[#18181b] border-white shadow-[8px_8px_0px_#ffffff] hover:shadow-[12px_12px_0px_#ffffff]"
                  : "bg-[#e5e5e5] border-black shadow-[8px_8px_0px_#000000] hover:shadow-[12px_12px_0px_#000000]"
              }`}
            >
              ...
              <div className="space-y-4 text-left font-bold text-base sm:text-xl md:text-2xl leading-relaxed">
                <p
                  className={`p-4 border-4 transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 ${
                    isDarkMode
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4 font-mono">
              ...
              <button
                onClick={handleGoHome}
                className={`font-black px-5 py-2.5 text-base border-4 cursor-pointer transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-0.5 active:translate-y-0.5 uppercase shrink-0 ${
                  isDarkMode
            ...
            <div
              className={`border-4 p-4 sm:p-6 mb-8 flex flex-col sm:flex-row items-center justify-between gap-4 transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 ${
                isDarkMode
                  ? "bg-[#18181b] border-white shadow-[8px_8px_0px_#ffffff] hover:shadow-[12px_12px_0px_#ffffff]"
                  : "bg-[#e5e5e5] border-black shadow-[8px_8px_0px_#000000] hover:shadow-[12px_12px_0px_#000000]"
              }`}
            >
              <div className="min-w-0 flex-1">
                ...
                <span
                  className={`text-lg sm:text-2xl md:text-3xl font-mono font-black select-all tracking-wide break-all ${
                    isDarkMode ? "text-white" : "text-black"
                  }`}
                >
                  {fullEmail}
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <button
                  onClick={handleCopy}
                  className={`font-black px-6 py-3 text-lg border-4 cursor-pointer transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-0.5 active:translate-y-0.5 flex items-center justify-center gap-2 uppercase ${
                    isDarkMode
                      ? "bg-[#ff5a5f] text-black border-white shadow-[4px_4px_0px_#ffffff] hover:bg-white hover:text-[#ff5a5f] hover:shadow-[7px_7px_0px_#ffffff] active:shadow-[1px_1px_0px_#ffffff]"
                      : "bg-[#ff5a5f] text-white border-black shadow-[4px_4px_0px_#000000] hover:bg-black hover:text-[#ff5a5f] hover:shadow-[7px_7px_0px_#000000] active:shadow-[1px_1px_0px_#000000]"
                  }`}
                ...
                <button
                  ...
                  className={`font-black p-3 text-lg border-4 cursor-pointer transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-0.5 active:translate-y-0.5 ${
                    isDarkMode
            ...
            <div
              className={`border-4 p-4 sm:p-6 mb-2 flex-1 flex flex-col min-h-[360px] sm:min-h-[420px] transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 ${
                isDarkMode
                  ? "bg-[#18181b] border-white shadow-[8px_8px_0px_#ffffff] hover:shadow-[12px_12px_0px_#ffffff]"
                  : "bg-[#e5e5e5] border-black shadow-[8px_8px_0px_#000000] hover:shadow-[12px_12px_0px_#000000]"
              }`}
            >
              <div
                className={`flex items-center justify-between pb-4 mb-4 border-b-4 ${
              ...
              >
                ...
                <span
                  className={`px-4 py-1 font-mono font-black text-xl border-2 ${
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  {emails.map((mail) => (
                    <div
                      key={mail.id}
                      className={`border-4 p-4 cursor-pointer transition-all duration-150 hover:-translate-x-1 hover:-translate-y-1 active:translate-x-0.5 active:translate-y-0.5 ${
                        isDarkMode
      ...
      {selectedEmail && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md p-4 sm:p-8 flex items-center justify-center font-mono">
          ...
          >
            <div
              className={`flex items-start justify-between pb-4 border-b-4 gap-4 ${
                isDarkMode ? "border-white" : "border-black"
              }`}
            >
              <div>
              ...
              <button
                ...
                className={`border-4 p-2 font-black cursor-pointer transition-all duration-150 hover:-translate-x-0.5 hover:-translate-y-0.5 active:translate-x-1 active:translate-y-1 ${
                  isDarkMode
            ...
            {/* TAB SELECTOR */}
            <div
              className={`flex items-center gap-2 py-3 border-b-4 ${
                isDarkMode ? "border-white" : "border-black"
              }`}
            >
              <button
                onClick={() => setViewTab("html")}
                className={`px-4 py-2 font-black text-sm border-4 cursor-pointer transition-all duration-150 ${
                  viewTab === "html"
                    ? "bg-[#ff5a5f] text-black border-white shadow-[3px_3px_0px_#ffffff]"
                    : isDarkMode
                ...
                <iframe
                  srcDoc={`
                    ...
                    <html>
                      <head>
                        <style>
                          body { font-family: system-ui, sans-serif; color: ${
                            isDarkMode ? "#f8fafc" : "#000000"
                          }; background: ${
                    isDarkMode ? "#090d16" : "#ffffff"
      ...
      {qrModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 font-mono">
          <div
            className={`border-4 p-6 max-w-sm w-full text-center relative ${
              isDarkMode
          ...
          >
            <button
              ...
              className={`absolute top-4 right-4 border-4 p-1 font-black cursor-pointer transition-all duration-150 hover:-translate-x-0.5 hover:-translate-y-0.5 ${
                isDarkMode
            ...
            {qrDataUrl && (
              <div
                className={`p-4 inline-block mb-4 border-4 ${
                  isDarkMode
            ...
            <p
              className={`text-sm font-mono p-3 border-4 font-black select-all ${
                isDarkMode
